...
start:
 ...
 MOV R0,#00h ;    Register R0 = 0 Zähler für DPTR
...
main:
 ...
 ACALL output ;    Wechsel in den Unterprogramm "output"
 ...
 ACALL delay ;     Wechsel in den Unterprogramm "delay"
...
delay:
 ...
 RET ;            Zurück zum Ausgangspunkt (Z=16)
...
output:
 ...
 RET ;               Zurück zum Ausgangspunkt (Z=11)
